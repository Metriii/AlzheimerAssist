...
export class LoginComponent {
  ...
  entrarPaciente() {
    ...
    if (!paciente.foto) {
      ...
      alert(
        'Paciente não possui foto facial cadastrada.'
      );
  ...
  loginCuidador() {
    ...
    if (!cuidador) {
      ...
      alert(
        'Email ou senha incorretos, ou cuidador não cadastrado.'
      );
  ...
  campoInvalido(
    ...
    return this.camposInvalidos.includes(
      campo
    );
